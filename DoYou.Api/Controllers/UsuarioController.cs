...
using DoYou.Domain.Commands.Usuario.CadastrarUsuario;
...
namespace DoYou.Api.Controllers
{
    public class UsuarioController : Base.ControllerBase
    {
        ...
        public UsuarioController(IMediator mediator, IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor) : base(unitOfWork)
        {
            _mediator = mediator;
